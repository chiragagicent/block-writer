...
},{"@editorjs/editorjs":"3TToX","@editorjs/header":"41vG9","@editorjs/list":"iR9Po","@editorjs/embed":"lhDVD","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3","@editorjs/image":"gKBP1"}],"3TToX":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"gKBP1":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
class j {
   ...
   * @returns {void}
   */ toggleStatus(a) {
        for(const i in j.status)Object.prototype.hasOwnProperty.call(j.status, i) && this.nodes.wrapper.classList.toggle(`${this.CSS.wrapper}--${j.status[i]}`, a === j.status[i]);
    }
    /**
        ...
        return function(i) {
                            ...
                            function h(T, C) {
                                try {
                                    if (C && (typeof C == "object" || typeof C == "function")) {
                                        var S = C.then;
                                        if (typeof S == "function") return void S.call(C, function(O) {
                                            h(T, O);
                                        }, s);
                                    }
                                    g[T] = C, --m == 0 && l(g);
            ...
            function(i, c, r) {
                ...
                var o, d, b, u, f, p, y, w = r(8), v = (d = function(t) {
                    return new Promise(function(e, l) {
                        ...
                        s.upload.addEventListener("progress", function(m) {
                            ...
                            if (s.readyState === 4) {
                                ...
                                var h = w.parseHeaders(s.getAllResponseHeaders()), k = {
                                    body: m,
                                    code: s.status,
                                    headers: h
                                };
                    ...
                    if (t.headers = t.headers || {}, t.type && (typeof t.type != "string" || !Object.values(o).includes(t.type))) throw new Error("`type` must be taken from module's \xabcontentType\xbb library");
            ...
            function(i, c) {
                var r = function(o) {
                    ...
                    return d = d || null, b = b || "&", u = u || null, o ? (function(f) {
                        ...
                        var p, y, w = f;
                        if (u && (w = u + "[" + w + "]"), typeof o[f] == "object" && o[f] !== null) p = n(o[f], null, b, w);
                        else {
...
class B {
   ...
   */ uploadByFile(a, { onPreview: i }) {
        ...
        let r;
        if (this.config.uploader && typeof this.config.uploader.uploadByFile == "function") r = this.config.uploader.uploadByFile(a), _(r) || console.warn("Custom uploader method uploadByFile should return a Promise");
        else {
